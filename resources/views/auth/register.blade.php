				...
				<div class="col-lg-12">
					<div class="breatcome_title">
						...
						<div class="breatcome_content">
							<ul>
								<li><a href="{{ url('/') }}">Home</a> <i class="fa fa-angle-right"></i> <span>Register</span></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row cnt_box align-items-center">
				...
				<div class="col-xl-6 pl-5 pr-5">
					...
					<div class="quote_wrapper">
						<form id="contact_form" action="{{ url('/user_registration') }}" method="POST" id="dreamit-form">
							@csrf
							<div class="row">
								<div class="col-lg-6">
								...
								<div class="col-lg-6">
									<div class="form_box mb-30">
										<input type="text" name="password_c" placeholder="Confirm password">
