    ...
    <div class="card">
        <div class="card-header header-elements-inline s-filter">
        	<div class="col-sm-6 mb-1" align="left">
			    <h6 class="card-title"><b>Add Courses Level Details</b></h6>
            </div>
        ...
        <div class="card-body"> 
            <form class="CoursesLevelDetails" action="{{route('courses_level.update',$level->id)}}" method="POST">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="level" class="form-control" id="level" value="{{$level->level}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Level Description</label>
                                    <input type="text" name="description" class="form-control" id="description" value="{{$level->description}}">
                                </div>
                            </div>
                        </div>
                    </div>
