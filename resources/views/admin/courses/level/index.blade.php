    ...
    <div class="card">
        <div class ="card-header header-elements-inline s-filter">
            <div class="col-md-6 mb-1">
                <h6 class="card-title"><b>Courses Level List</b></h6></div>

                <div class="col-md-6 text-right">
                <a class="btn btn-primary btn-sm" href="{{route('courses_level.create')}}">
        ...
        <table class="table get_courses_Level_data">
            <thead>
                <tr>
                    <th>S.No.</th>
                    <th>LEVEL NAME</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // init datatable.
        var dataTable = $('.get_courses_Level_data').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: false,
            pageLength: 7,
        ...
        $('body').on('click', '.delete-course-level', function () {
            ...
            swalInit.fire({
                ...
                if(result.value) {
                    $.ajax({
                        type:'DELETE',
                        url : "{{ url('/admin/courses_level') }}"+'/'+id,
