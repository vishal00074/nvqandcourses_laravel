    ...
    <div class="card">
        <div class ="card-header header-elements-inline s-filter">
            <div class="col-md-6 mb-1">
                <h6 class="card-title"><b>Enrolled Courses Guest User List</b></h6>
            </div>
        ...
        <table class="table enrolled_guest">
            <thead>
                <tr>
                    <th>S.No.</th>
                    <th>COURSE NAME</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // init datatable.
        var dataTable = $('.enrolled_guest').DataTable({
            processing: true,
            serverSide: true,
            autoWidth: false,
            pageLength: 7,
