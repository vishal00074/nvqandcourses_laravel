...
<body style="background-color:#e2e1e0;font-family: Open Sans, sans-serif;font-size:100%;font-weight:400;line-height:1.4;color:#000;">
  <table style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border-top: solid 10px #015ab9;">
    <thead>
      <tr>
        <th style="text-align:left;"><img src="https://nvqandcourses.co.uk/frontend/assets/images/1.png" height="50px"  alt="NVQ Courses" /></th>
    ...
    <tr>
        <td colspan="2" style="font-size:14px;padding:0px 15px 0 0px;">
          ...
          We are pleased to inform you that your application for the course {{ $course->name }} has been successfully received. In the meantime, if you have any questions or require further assistance, please feel free to reach out to our dedicated support team at {{ $contact->email }}. We are here to provide you with any information you may need.
        </td>
      </tr>
    </tfooter>
  </table>
