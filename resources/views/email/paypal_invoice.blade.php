    ...
    <tbody>
      ...
      <tr>
        <td colspan="2">
          <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;">
            <span style="display:block;font-size:15px;font-weight:600;">{{ $envoices->name }}</span><b style="font-size:13px;font-weight:normal;">Price : £{{ $envoices->total_price }}   </b>  
          </p>
      ...
      <tr>
        <td style="width:50%;padding:20px 20px 20px 0;vertical-align:top">
          <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px">Transaction ID</span>{{  $arr['id'] }}</p>
          <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">Amount Paid </span> £{{ $arr['transactions'][0]['amount']['total'] }}</p>
          
        </td>
        <td style="width:50%;padding:20px;vertical-align:top">
          <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">Status :</span> {{ $arr['state'] }}</p>
        </td>
      </tr>
    </tbody>
